...
public class ObjectUtility {
    ...
    private static final org.apache.log4j.Logger OBJECT_UTILITY_LOGGER = org.apache.log4j.Logger.getLogger(ObjectUtility.class);
    ...
    public void addInterface(final Context context, final String buisnessObjectid, String interfaceNamesInXMLMap, String vault) throws MatrixException {
        ...
        try {
            ...
            OBJECT_UTILITY_LOGGER.info("#################################################################");
            OBJECT_UTILITY_LOGGER.info("Business Object : 'Type' : '" + busnessObject.getTypeName() + "' 'Name' : '" + busnessObject.getName() + "' 'Revision' : '" + busnessObject.getRevision() + "'");
            OBJECT_UTILITY_LOGGER.info("#################################################################");
