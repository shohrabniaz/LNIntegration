tcl;
eval {
	file mkdir "JPO_Backups"
	
	set fp_LogFile [open "jpo_deployment_execution.log" "w"]
	set fp_err_LogFile [open "jpo_deployment_execution_error.log" "w"]
	...
	set iRetCode [ catch {
		...
		backupProgram "emxCustomTriggerProcess" $fp_LogFile

		addProgram "emxCustomTriggerProcess" "emxCustomTriggerProcess_mxJPO.java" $fp_LogFile

		compileProgram "emxCustomTriggerProcess" $fp_LogFile

		verifyJPO "emxCustomTriggerProcess" $fp_LogFile $fp_err_LogFile
