...
Invoke-WebRequest -Uri 'https://dspp21integration.plm.valmet.com/EnoviaRestService/gts-services/nightlyUpdatesLN' | Out-File -Append H:\Integrations\LNTransfer\gts_nightly_update.log
Start-Sleep -s 15
