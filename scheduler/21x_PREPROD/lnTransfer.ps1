...
Invoke-WebRequest -Uri 'https://dspp21integration.plm.valmet.com/EnoviaRestService/bomExportToLN' | Out-File -Append H:\Integrations\LNTransfer\Ln_Scheduler.log
#Start-Sleep -s 15
