...
Invoke-WebRequest -Uri 'https://3dspace-18xmigr2.plm.valmet.com:443/EnoviaRestService/bomExportToLN' | Out-File -Append D:\Integrations\LNTransfer\Ln_Scheduler.log
#Start-Sleep -s 15
